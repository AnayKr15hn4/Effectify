...
export function LoginPage() {
  ...
  <div className="mb-4">
    <button
      ...
      className="w-full bg-white text-zinc-900 font-bold py-3 rounded-lg transition-all active:scale-95 hover:bg-zinc-200 flex items-center justify-center gap-2"
    >
